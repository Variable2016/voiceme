<template>
  <div>
    <nav class="sticky top-0 lg:px-16 px-6 bg-white flex flex-wrap items-center lg:py-0 py-2">
    ...
    <div
      class="bg-cover bg-center absolute z-0 h-screen bg-no-repeat"
        ...
        <header class="z-20 w-full xl:px-0 px-2">
          <div class="container mx-auto flex flex-wrap mt-8 mb-8">
            <div class="flex sm:w-1/2 flex">
              ...
              <a href="/" class="text-2xl text-white ml-1 font-bold">VoiceMe</a>
            </div>
