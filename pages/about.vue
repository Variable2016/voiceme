  ...
  <div class="gradient">
    ...
    <header class="pt-9">
      <div class="container px-1 py-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        >
          <h1 class="my-4 text-5xl font-bold leading-tight text-center">About VoiceMe.AI</h1>
          <h3
            class="my-4 text-4xl font-bold leading-tight text-center"
          >Strengthen team by improving communication</h3>
    ...
    <section class="bg-white border-b py-8">
      <a class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="w-full mb-4">
          ...
          <p class="w-full my-2 text-2xl text-center text-gray-800 border px-8">
            We started Voiceme.AI to help those people who are techno-phobic make the leap into a digital world.align-bottom.
            Most things in life boild down to communication. Almost communication today is digital, and for millions of workers across the country this is real concern.
