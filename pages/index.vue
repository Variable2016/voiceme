  ...
  <div class="leading-normal tracking-normal text-white gradient">
    ...
    <div class="pt-10">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        >
          <h1 class="my-4 text-5xl font-bold leading-tight">Better Communication</h1>
          <p class="leading-normal text-2xl mb-8 text-center md:text-center">Better Service</p>

          <button
            class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg"
          >Apply for VoiceMe pilot group</button>
        </div>
        <!--Right Col-->
        <div class="w-full md:w-3/5 py-4 text-center">
          <img class="w-full md:w-4/5 z-50" src="~/assets/hero1.png" />
        </div>
      </div>
    </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      >When your team communicates well, Everything falls in place</h3>
