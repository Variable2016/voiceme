      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        >
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <nuxt-link class="inline-block py-2 px-4 text-black font-bold no-underline" to="/dashboard">Dashboard</nuxt-link>
            </li>
            <li class="mr-3">
              <nuxt-link
    ...
    <div class="pt-10">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        >
          ...
          <p class="leading-normal text-2xl mb-8 text-center md:text-center">Better Communication, Better Service</p>
...
<section class="bg-white border-b py-8">
	<div class="container max-w-7xl mx-auto m-8">
		<h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Our Solution
</h1>
		<div class="w-full mb-4">
			<div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
		</div>
		...
		<div class="flex flex-wrap">
			<div class="w-5/6 sm:w-1/2 p-6">
				<h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">Walkie-Talkie Integration

</h3>
				<p class="text-gray-600 mb-8">Captures all walkie-talkie communications instantly on VoiceMe.AI’s Management Dashboard.
...
<!------------------------Features Ends-------------->
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <p
        class="my-4 text-1xl leading-tight"
      ...
      Lock in earlier adapter pricing as added benefit. There are only four accounts left</p>
